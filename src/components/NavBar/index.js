...
const LSUBase = props => {
  ...
  return(
    <Modal {...props} aria-labelledby = "contained-modal-title-vcenter" className = "lsuModal" centered>
      <Modal.Header style = {{backgroundColor: "#050505", color: "#FA3264", paddingBottom: "0px"}}>
        <h4 style = {{fontFamily: "madeEvolve"}}><span style = {{color: "#FEE715FF"}}>#</span><span style = {{color: "whitesmoke"}}>NITR</span> codes</h4>
      </Modal.Header>
        ...
        <div style = {{width: "80%", margin: "auto"}}>
          ...
          <Form onSubmit = {onCreate}>
            ...
            <InputGroup className = "LSUgroup">
              ...
              <FormControl className = "LSU" required pattern = "[0-9]{3}[A-Za-z]{2}[0-9]{4}" value = {sRoll} onChange = {event => {setSRoll(event.target.value); setSEmail(event.target.value+"@nitrkl.ac.in");}} placeholder = "Roll No. (Ex. 119CS0XXX)" />
            </InputGroup>
            <InputGroup className = "LSUgroup">
